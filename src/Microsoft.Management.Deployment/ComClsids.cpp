...
namespace winrt::Microsoft::Management::Deployment
{
    CLSID GetRedirectedClsidFromInProcClsid(REFCLSID clsid)
    {
        ...
        else if (IsEqualCLSID(clsid, WINGET_INPROC_COM_CLSID_ErrorInformationProvider))
        {
            return __uuidof(winrt::Microsoft::Management::Deployment::implementation::ErrorInformationProvider);
        }
        else
        {
            return CLSID_NULL;
